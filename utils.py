...
def add_orders_data(class_name, data) -> list:
    """
    Функция наполняет Базу данных экземплярами
    """
    orders = []
    for order in data:
...
def add_new_user(class_name, data):
    """
    Функция добавляет новый экземпляр класса User
...
def add_new_order(class_name, data):
    """
    Функция добавляет новый экземпляр класса Order
    """
...
def add_new_offer(class_name, data):
    """
    Функция добавляет новый экземпляр класса Offer
    """
